      ...
      <div className="w-full max-w-[340px] flex flex-col items-center">
        ...
        <div className="w-full bg-card border border-border p-7 rounded-2xl shadow-2xl">
          <div className="mb-8 text-center">
            ...
            <p className="text-muted-foreground text-[13px] font-medium">Welcome back to Archy AI</p>
          </div>
          ...
          <form action={signInWithGoogle} className="flex flex-col gap-6">
            ...
            <p className="text-[11px] text-muted-foreground text-center leading-relaxed px-4 font-medium">
              By continuing, you agree to our <Link href="#" className="text-foreground hover:underline underline-offset-4">Terms of Service</Link> and <Link href="#" className="text-foreground hover:underline underline-offset-4">Privacy Policy</Link>
            </p>
            ...
            <div className="pt-4 border-t border-border mt-2">
              ...
              >
                Don&apos;t have an account? <span className="text-[#5D5DFF] hover:underline underline-offset-4">Sign Up</span>
              </Link>
            </div>
          </form>
        </div>
